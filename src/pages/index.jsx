...
const labs = [
  ...
  {
    title: 'Agentic Workflows Repo Analyzer',
    description: 'Create a GitHub Agentic Workflow for automated weekly repository health reports.',
    duration: '~45 min',
    level: 'Intermediate',
    link: '/labs/agentic-workflows-repo-analyzer',
  },
  {
    title: 'Customization in 90 Minutes',
    description: 'Build an SDLC multi-agent framework with skills, agents, orchestration, and model optimization.',
    duration: '~90 min',
    level: 'Intermediate',
    link: '/labs/customization-in-90-minutes',
  },
  {
    title: 'Context Engineering — Every Token Counts',
    description: 'Measure, optimize, and engineer AI context windows — cutting token waste and reducing costs.',
    duration: '~2 hours',
    level: 'Intermediate',
